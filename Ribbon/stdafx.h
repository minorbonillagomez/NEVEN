...
class DECLSPEC_UUID("443a0014-c3f3-4ced-a258-f170aff12659") RJ2XCL2RibbonLib;

using namespace ATL;

class CRJ2XCL2RibbonModule : public CAtlDllModuleT< CRJ2XCL2RibbonModule >
{
public:
    CRJ2XCL2RibbonModule()
	{
		m_hInstance = NULL;
	}

	DECLARE_LIBID(__uuidof(RJ2XCL2RibbonLib))
...
extern CRJ2XCL2RibbonModule _AtlModule;

// @see RJ2XCLCOM.cpp about these files

#include "..\OfficeTypes\mso-15.tlh"
using namespace Office;

#include "..\OfficeTypes\excel-15.tlh"
