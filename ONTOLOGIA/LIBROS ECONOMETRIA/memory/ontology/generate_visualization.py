...
TYPE_COLORS = {
    ...
    "Framework": "#aa98b5",
    "Dataset": "#14b8a6",
    "StatisticalTest": "#e879a9",  # Rosa para tests
}
...
REL_COLORS = {
    ...
    "implemented_in_r_package": "#3b82f6",
    "part_of": "#8b5cf6",
    "tests_for": "#ec4899",
    "uses_r_function": "#06b6d4",
    "uses_dataset": "#14b8a6",
}
...
def generate_html(entities, relations, output_path):
    ...
    for eid, entity in entities.items():
        ...
        description = props.get("description", props.get("definition", ""))[:200]
        ...
        node = {
            ...
            "shape": "dot" if etype in ["Concept", "Assumption"] else "box",
            "size": 15 if etype == "Framework" else 10,
            "type": etype,
            "fullName": name,
...
<head>
  ...
  <title>Ontología de Econometría & ML — NEVEN</title>
...
<body>
  ...
  <div id="sidebar">
    <div class="sidebar-header">
      <h2>🧠 Ontología Econometría & ML</h2>
