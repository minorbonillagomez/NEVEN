...
# CM-BAJ-007: TestAdd y EigenValues eliminados v2.3
# Eran funciones de prueba/demo residuales sin uso en producción.
# - TestAdd: suma trivial, reemplazada por J.Algebra(M, V, 12) para sistemas lineales
# - EigenValues: wrapper de eigvals(), reemplazada por J.Algebra(M, nothing, 4)
