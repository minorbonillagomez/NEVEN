R4XCL_INT_PROCEDIMIENTOS <- function()
{
  ...
  Reg_Poisson <- 
    c(
        ...
        "[5] Guardar Modelo Estimado en R",
        "[6] Info de Ejecución",
        "[7] Guardar Modelo Estimado en RDS",
        "[8] Tabla_Completa_Outputs"
     )
  ...
  AD_KMedias <-  
    c(
        ...
        "[6] Test GAP",
        "[7] K-Optimo",
        "[8] Guardar Modelo en RDS",
        "[9] Info de Ejecución",
        "[10] Tabla_Completa_Outputs"
    )
