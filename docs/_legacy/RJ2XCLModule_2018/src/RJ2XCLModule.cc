...
SEXP Callback2(SEXP command, SEXP data){
  static CALLBACK_FUNCTION *function = (CALLBACK_FUNCTION*)R_GetCCallable("RJ2XCLControlR", "Callback");
 ...
 * allocations here.
 *
 * NOTE: Parameter validation could be added for robustness.
 */ 
...
extern "C" {
  void R_init_RJ2XCLModule(DllInfo *info)
  {
